...
public class msg_open_drone_id_authentication extends MAVLinkMessage {
     ...
     */
    public msg_open_drone_id_authentication( long timestamp, short target_system, short target_component, short[] id_or_mac, short authentication_type, short data_page, short page_count, short length, short[] authentication_data) {
        this.msgid = MAVLINK_MSG_ID_OPEN_DRONE_ID_AUTHENTICATION;
     ...
     */
    public msg_open_drone_id_authentication( long timestamp, short target_system, short target_component, short[] id_or_mac, short authentication_type, short data_page, short page_count, short length, short[] authentication_data, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_OPEN_DRONE_ID_AUTHENTICATION;
        this.sysid = sysid;
        this.compid = compid;
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_OPEN_DRONE_ID_AUTHENTICATION - sysid:"+sysid+" compid:"+compid+" timestamp:"+timestamp+" target_system:"+target_system+" target_component:"+target_component+" id_or_mac:"+id_or_mac+" authentication_type:"+authentication_type+" data_page:"+data_page+" page_count:"+page_count+" length:"+length+" authentication_data:"+authentication_data+"";
    }
