...
TEST(MavlinkSenderTest, SendHeartbeat_Default) {
    ...
    EXPECT_EQ(buffer[MAVLINK_V2_SYSID_OFFSET], mavlinkio::SYSTEM_ID_GCS);  // default system_id
    EXPECT_EQ(buffer[MAVLINK_V2_COMPID_OFFSET], mavlinkio::COMPONENT_ID_MISSIONPLANNER); // default component_id
