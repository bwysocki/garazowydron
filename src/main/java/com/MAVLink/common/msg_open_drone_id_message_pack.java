...
public class msg_open_drone_id_message_pack extends MAVLinkMessage {
     ...
     */
    public msg_open_drone_id_message_pack( short target_system, short target_component, short single_message_size, short msg_pack_size, short[] messages) {
        this.msgid = MAVLINK_MSG_ID_OPEN_DRONE_ID_MESSAGE_PACK;
     ...
     */
    public msg_open_drone_id_message_pack( short target_system, short target_component, short single_message_size, short msg_pack_size, short[] messages, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_OPEN_DRONE_ID_MESSAGE_PACK;
        this.sysid = sysid;
        this.compid = compid;
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_OPEN_DRONE_ID_MESSAGE_PACK - sysid:"+sysid+" compid:"+compid+" target_system:"+target_system+" target_component:"+target_component+" single_message_size:"+single_message_size+" msg_pack_size:"+msg_pack_size+" messages:"+messages+"";
    }
