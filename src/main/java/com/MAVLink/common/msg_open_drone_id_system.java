...
public class msg_open_drone_id_system extends MAVLinkMessage {
     ...
     */
    public msg_open_drone_id_system( int operator_latitude, int operator_longitude, float area_ceiling, float area_floor, int area_count, int area_radius, short target_system, short target_component, short[] id_or_mac, short operator_location_type, short classification_type, short category_eu, short class_eu) {
        this.msgid = MAVLINK_MSG_ID_OPEN_DRONE_ID_SYSTEM;
     ...
     */
    public msg_open_drone_id_system( int operator_latitude, int operator_longitude, float area_ceiling, float area_floor, int area_count, int area_radius, short target_system, short target_component, short[] id_or_mac, short operator_location_type, short classification_type, short category_eu, short class_eu, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_OPEN_DRONE_ID_SYSTEM;
        this.sysid = sysid;
        this.compid = compid;
